...
st.markdown("""
    <style>
        /* Make the comparison card scroll horizontally on mobile instead of squishing */
        [data-testid="stMarkdownContainer"] > div {
            overflow-x: auto;
        }
        
        /* Prevent Streamlit's column gap from causing overflow */
        .compare-card {
            min-width: 320px;
        }
        
        /* Tighten tab padding on mobile */
