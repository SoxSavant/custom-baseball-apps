...
from h_utils import (
    load_final_year,
    POSITION_OPTIONS, normalize_team,
    apply_dh_override,
    filter_by_position,
...
STAT_MANUAL_KEY   = "hdb_stat_manual_update"
ADD_SELECT_KEY    = "hdb_add_stat_select"
REMOVE_SELECT_KEY = "hdb_remove_stat_select"
...
with left_col:
    ...
    config_df = pd.DataFrame([
        {"Stat": STAT_DISPLAY_NAMES.get(r["Stat"], r["Stat"]), "Show": bool(r.get("Show", True))}
