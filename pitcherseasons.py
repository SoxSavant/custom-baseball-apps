...
st.set_page_config(page_title="Pitcher Season Counter", layout="wide", page_icon="⚾")
...
with title_col:
    st.title("Pitcher Season Counter")
with meta_col:
    st.markdown(
...
<div class="leaderboard-card">
    ...
    <div class="footer"><p>By: Sox_Savant</p><p>Data: FanGraphs • Baseball Reference • Baseball Savant</p></div>
</div>
</body>
</html>"""
